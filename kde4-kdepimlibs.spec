...
%attr(755,root,root) %{_libdir}/kde4/plugins/designer/akonadiwidgets.so
...
%attr(755,root,root) %{_libdir}/kde4/akonadi/akonadi_test_searchplugin.so
%{_libdir}/kde4/akonadi/akonaditestsearchplugin.desktop
